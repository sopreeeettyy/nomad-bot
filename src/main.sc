...
theme: /
    ...
    state: Узнать результат
        script:
            ...
            $response.replies.push({type:"text",text:"<b>Поздравляю!</b> <br><br>Ты ответил правильно на <b>"+$session.test+" "+($session.test%10===1&&$session.test%100!==11?"вопрос":($session.test%10>=2&&$session.test%10<=4&&($session.test%100<12||$session.test%100>14)?"вопроса":"вопросов"))+"</b> из <b>17!</b> <br><br>Получи свой </b>стикер</b> у промоперсонала за прохождение активации. Чем <b>больше</b> активностей ты пройдёшь, тем <b>больше</b> заработаешь стикеров и сможешь получить <b>самые ценные призы!</b> <br><br><b>Твой Лис Рыжик!</b>", markup:"html"});