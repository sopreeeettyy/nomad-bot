...
theme: /
    ...
    state: Выбор компании
        a: Отлично! А теперь подскажи, в какой компании ты работаешь? Выбери из предложенных вариантов. Если ты пришёл поддержать своего близкого человека, выбирай кнопку «гость». || htmlEnabled = true, html = "Отлично! <br><br>А теперь подскажи, <b>в какой компании ты работаешь?</b> Выбери из предложенных вариантов. Если ты пришёл поддержать своего близкого человека, выбирай кнопку <b>«гость»</b>"
        buttons:
            "СУЭК"
            "СГК"
            "ЕвроХим"
