...
theme: /
    ...
    state: Первый вопрос
        ...
        buttons:
            "1995" -> /Второй вопрос (неверно)
            "1989" -> /Второй вопрос (неверно)
            "1991" -> /Второй вопрос (неверно)
            "2001" -> /Второй вопрос (верно)

    state: Второй вопрос (верно)
        a: Правильно! Компания основана в 2001 году.
        buttons:
            "Дальше"

    state: Второй вопрос (неверно)
        a: Увы, компания основана в 2001 году. Будь немного внимательнее в следующем вопросе.
        buttons:
            "Дальше"