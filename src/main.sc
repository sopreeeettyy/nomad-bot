...
theme: /
    ...
    state: Для компаний
        InputText: 
            prompt = <b>Вопрос 15:</b> <br><br>Что вам больше всего нравится в работе в нашей компании и почему? 
    ...
    state: Шестанд
        InputText: 
            prompt = <b>Вопрос 16:</b> <br><br>С какими основными трудностями или проблемами вы сталкиваетесь в своей работе?
    ...
    state: Семнад
        InputText: 
            prompt = <b>Вопрос 17:</b> <br><br>Что, по вашему мнению, мы могли бы изменить или улучшить, чтобы сделать компанию лучше для сотрудников?
    ...
    state: Результаты
        a: Ура! Ты прошёл тест и ответил на все вопросы! Осталось посчитать баллы. Жми кнопку «результат». || htmlEnabled = true, html = "<b>Ура!</b> <br><br>Ты прошёл тест и ответил на все вопросы! Осталось посчитать баллы. <br><br><b>Жми кнопку «результат».</b>"
        buttons:
            "Узнать результат"
