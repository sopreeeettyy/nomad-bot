...
theme: /
    ...
    state: Шестанд
        a: Вопрос 16: С какими основными трудностями или проблемами вы сталкиваетесь в своей работе? || htmlEnabled = true, html = "<b>Вопрос 16:</b> <br><br>С какими основными <b>трудностями</b> или <b>проблемами</b> вы сталкиваетесь в своей работе?"
        InputText: 
            prompt = 
    ...
    state: Семнад
        a: Вопрос 17: Что, по вашему мнению, мы могли бы изменить или улучшить, чтобы сделать компанию лучше для сотрудников? || htmlEnabled = true, html = "<b>Вопрос 17:</b> <br><br>Что, по вашему мнению, мы могли бы <b>изменить</b> или <b>улучшить</b>, чтобы сделать компанию лучше для сотрудников?"
        InputText: 
            prompt = 
    ...
    state: Узнать результат
        script:
            ...
            $response.replies.push({type:"text",text:"<b>Поздравляю!</b> <br><br>Ты ответил правильно на <b>"+$session.test+" "+($session.test%10===1&&$session.test%100!==11?"вопрос":($session.test%10>=2&&$session.test%10<=4&&($session.test%100<12||$session.test%100>14)?"вопроса":"вопросов"))+"</b> из <b>14!</b> <br><br></b>Вопросы 15, 16, 17 не считаются</b> <br><br>Получи свой </b>стикер</b> у промоперсонала за прохождение активации. Чем <b>больше</b> активностей ты пройдёшь, тем <b>больше</b> заработаешь стикеров и сможешь получить <b>самые ценные призы!</b> <br><br><b>Твой Лис Рыжик!</b>", markup:"html"});